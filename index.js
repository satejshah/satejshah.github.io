...
// d3.csv("Bulls.18-19.CS498.csv")
//     .row(function(d){ return {year: parseDate(d.year), wins:Number(d.wins)}; })
...
function update(selectedVar) {
  ...
  d3.csv("Bulls.18-19.CS498.csv", function(data) {
    ...
    var mousemove = function(d) {
    Tooltip
      .html("Points: " + d[selectedVar]).style("left", (d3.mouse(this)[0]+90) + "px").style("top", (d3.mouse(this)[1]) + "px")
    }
    var mouseleave = function(d) {
    Tooltip
      .style("opacity", 0)
